...
{
    public class GetLeaveTypeDtoDetailQuery : IRequestHandler<GetLeaveTypeDtoDetailRequest, LeaveTypeDto>
    {
        private readonly ILeaveTypeRepository _leaveTypeRepository;
        private readonly IMapper _mapper;

        public GetLeaveTypeDtoDetailQuery(ILeaveTypeRepository leaveTypeRepository, IMapper mapper)
        {
        ...
        {
           var leaveTypes = _leaveTypeRepository.GetAllLeaveTypes();
